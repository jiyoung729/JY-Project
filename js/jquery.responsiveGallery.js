		...
		function getTransform3CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('-30%',   -600, 0, 0,   0, 'hidden'),

	               getTransform3dCSS('-30%', -600, 0, 1,   1, 'visible'),
	               getTransform3dCSS('100%', 50, 0, 3, 1, 'visible'),
	               getTransform3dCSS('230%', -600, 0, 1, 1, 'visible'),

	               getTransform3dCSS('230%', -600, 0, 0,   0, 'hidden')
				];
			} else if(support2d){
				cssArray = [
